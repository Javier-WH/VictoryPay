...
public class CreatorString {
    ...
    //medical_info
    private static final String CreateMedicalInfoString = "CREATE TABLE medical_info (id INTEGER PRIMARY KEY AUTOINCREMENT, student_id INTEGER NOT NULL UNIQUE, diabetes TEXT NOT NULL, hipertension TEXT NOT NULL, dislexia TEXT NOT NULL, daltonismo TEXT NOT NULL, epilepsia TEXT NOT NULL, asma TEXT NOT NULL, alergias TEXT NOT NULL, TDAH TEXT NOT NULL, observations TEXT NOT NULL, updatedAT DATETIME DEFAULT CURRENT_TIMESTAMP)";
    //parents
    private static final String CreateParentsString = "CREATE TABLE parents (id INTEGER PRIMARY KEY AUTOINCREMENT, mother_name TEXT NOT NULL, mother_ci TEXT NOT NULL,  mother_nation TEXT NOT NULL, mother_work TEXT NOT NULL, father_name TEXT NOT NULL, father_ci TEXT NOT NULL, father_nation TEXT NOT NULL, father_work TEXT NOT NULL, updatedAT DATETIME DEFAULT CURRENT_TIMESTAMP)";
    //tutors
    private static final String CreateTutorsString = "CREATE TABLE tutors (id INTEGER PRIMARY KEY AUTOINCREMENT, tutor_name TEXT NOT NULL, tutor_ci TEXT NOT NULL, tutor_nation TEXT NOT NULL, tutor_link TEXT NOT NULL, updatedAT DATETIME DEFAULT CURRENT_TIMESTAMP)";
    //contact_info
    private static final String CreateContactInfoString = "CREATE TABLE contact_info (id INTEGER PRIMARY KEY AUTOINCREMENT, student_id INTEGER NOT NULL UNIQUE, phone1 TEXT NOT NULL, phone2 TEXT NOT NULL, email TEXT NOT NULL, whatsapp1 TEXT NOT NULL, whatsapp2 TEXT NOT NULL, updatedAT DATETIME DEFAULT CURRENT_TIMESTAMP)";
    //inscription_payment
