...
public class CreatorString {
    ...
    //medical_info
    private static final String CreateMedicalInfoString = "CREATE TABLE medical_info (id INTEGER PRIMARY KEY AUTOINCREMENT, student_id INTEGER NOT NULL UNIQUE, diabetes TEXT NOT NULL, hipertension TEXT NOT NULL, dislexia TEXT NOT NULL, daltonismo TEXT NOT NULL, epilepsia TEXT NOT NULL, asma TEXT NOT NULL, alergias TEXT NOT NULL, TDAH TEXT NOT NULL, observations TEXT NOT NULL, updatedAT TEXT DEFAULT (strftime('%m/%d/%Y %H:%M:%S', 'now', 'localtime')))";
    //parents
    ...
    //inscription_payment
    private static  final String CreateInscriptionPaymentString = "CREATE TABLE inscription_payment (id INTEGER PRIMARY KEY AUTOINCREMENT, student_id INTEGER NOT NULL UNIQUE, inscription TEXT NOT NULL, cash TEXT NOT NULL, operation_number TEXT NOT NULL, date TEXT NOT NULL, status TEXT NOT NULL, updatedAT TEXT DEFAULT (strftime('%m/%d/%Y %H:%M:%S', 'now', 'localtime')))";
    //schools
    ...
    //monthControl
    private static final String CreateMonthControlString = "CREATE TABLE monthControl (id INTEGER PRIMARY KEY AUTOINCREMENT, student_code TEXT NOT NULL UNIQUE, control TEXT NOT NULL, updatedAT TEXT DEFAULT (strftime('%m/%d/%Y %H:%M:%S', 'now', 'localtime')))";
    //abono
    private static final String CreateAbonoString = " CREATE TABLE abono (id INTEGER PRIMARY KEY AUTOINCREMENT, tutor_id TEXT NOT NULL UNIQUE, abono TEXT NOT NULL UNIQUE, updatedAT TEXT DEFAULT (strftime('%m/%d/%Y %H:%M:%S', 'now', 'localtime')))";
